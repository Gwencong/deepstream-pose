...
from utils.utils import get_total_outshape, postprocess, postprocessNoNMS
    ...
    while l_frame is not None:
        ...
        while l_usr is not None:
            ...
            try:
                ...
                # if DEBUG:
                #     pred = postprocess_nonms(model_outs,(MUX_OUTPUT_HEIGHT,MUX_OUTPUT_WIDTH),INFER_SHAPE[2:],frame_image)
                #     boxes, confs, kpts = pred
                # else:
                #     pred = postprocess_nonms(model_outs,(MUX_OUTPUT_HEIGHT,MUX_OUTPUT_WIDTH),INFER_SHAPE[2:])
                #     boxes, confs, kpts = pred
            except StopIteration:
                break
...
def main(args):
    ...
    pgie.set_property("config-file-path", "configs/config_infer_primary_1.txt")
